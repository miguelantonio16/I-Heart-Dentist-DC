...
<head>
    ...
    <title>My Sessions - IHeartDentistDC</title>
...
<body>
 ...
 <div class="nav-container">
     ...
     <table class="menu-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    if ($_SESSION['usertype'] == 'd') {
                                        echo '<a href="switch_to_admin.php"><input type="button" value="Enter admin view" class="admin-view-btn"></a>';
                                    }
                                    ?>
                                </td>
                            </tr>
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appointment">
                        <a href="dental-record.php" class="non-style-link-menu">
                            <div>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="margin-left:25px;background-image: url('../img/icons/add.svg'); width: 250px;">Add a Session</font></button>
                        </a>
                        </div>
                    </td>
                </tr>
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=view&id='.$scheduleid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view" style="padding-left: 40px;padding-top: 10px;padding-bottom: 10px;margin-top: 10px; margin-bottom: 10px;"><font class="tn-in-text">View</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="width: 200px; padding-left: 40px; padding-top: 10px; padding-bottom: 10px; margin-top: 10px; margin-bottom: 10px;"><font class="tn-in-text">Cancel Session</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Dentist of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
