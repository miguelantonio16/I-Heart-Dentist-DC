...
<head>
    ...
    <title>My Patients - IHeartDentistDC</title>
...
<body>
    ...
    // Fetch doctor data along with branch name (if assigned)
    $userrow = $database->query("SELECT d.*, b.name AS branch_name FROM doctor d LEFT JOIN branches b ON d.branch_id = b.id WHERE d.docemail='$useremail'");
    ...
    <div class="nav-container">
        ...
        <table class="menu-container" border="0">
                <tr>
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            <tr>
                                <td>
                                    <img class="profile-user" src="../Media/dashboard-icons/dentist-icon.png" alt="">
                                </td>
                                <td>
                                    <p class="profile-title"><?php echo substr($username, 0, 50) ?></p>
                                    <p class="profile-subtitle"><?php echo substr($useremail, 0, 24) ?>...</p>
                                    <?php if (!empty($userBranchName)): ?>
                                        <p style="margin-top:6px;font-size:13px;opacity:0.85;">
                                            <strong>Branch:</strong> <?php echo htmlspecialchars($userBranchName); ?>
                                        </p>
                                    <?php endif; ?>
                                </td>
                            </tr>
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-booking">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appointment menu-active menu-icon-appointment-active">
                        <a href="dental-record.php" class="non-style-link-menu non-style-link-menu-active">
                            <div>
                                <p class="menu-text">Dental Records</p>
                            </div>
                        </a>
                    </td>
                </tr>
    ...
    if ($_POST) {
        ...
        if (isset($_POST["search"])) {
            ...
            $sqlmain = "select distinct * from patient where pemail='$keyword' or pname='$keyword' or pname like '$keyword%' or pname like '%$keyword' or pname like '%$keyword%' ";
            $selecttype = "my";
        }
    ...
    WITH ranked_appointments AS (
        SELECT 
            ...
            ROW_NUMBER() OVER (PARTITION BY patient.pid ORDER BY appointment.appodate ASC) AS rn
        FROM appointment 
...
";
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows == 0) {
                                    ...
                                    for ($x = 0; $x < $result->num_rows; $x++) {
                                       ...
                                       <button class="btn-primary-soft btn button-icon btn-add" style="width: 200px; padding: 12px 5px; margin-top: 10px; margin-bottom: 10px; margin-right: 1em; margin-left: 1em;" onclick="openAddPopup()">
            <font class="tn-in-text">Add Dental Record</font>
        </button>
                                        <button class="btn-primary-soft btn button-icon btn-add" style="width: 200px;padding: 12px 5px; margin-top: 10px; margin-bottom: 10px">
    ...
    <!-- Add Popup Modal -->
    <div id="addPopup" class="overlay" style="display: none;">
        <div class="popup">
            <a class="close" href="javascript:void(0);" onclick="closeAddPopup()">&times;</a>

            <div class="header">
                <p class="header-button">
                    <font class="tn-in-text">DENTAL RECORD CHART</font>
                </p>

                <div class="parent">
                    <div class="header-details">
                        <p class="no-linebreak"><strong>Name:</strong></p><input class="input1" type="text" class="" placeholder=""><br>
                        <p class="no-linebreak"><strong>Patient ID:</strong></p><input class="input2" type="text" class="" placeholder=""><br>
                        <p class="no-linebreak"><strong>Age:</strong></p><input class="input3" type="text" class="" placeholder="">

                    </div>
                    <div class="header-details">
                        <p class="no-linebreak"><strong>Gender:</strong></p><input class="input4" type="text" class="" placeholder=""><br>
                        <p class="no-linebreak"><strong>Date:</strong></p><input class="input5" type="text" class="" placeholder="">
                    </div>
                </div>
            </div>
                ...
                <div class="main">
                    <div class="first">
                        <div class="large-3 columns">
                            ...
                            <div class="row">
                                <div class="large-6 columns">
                                    <p>Upper Right</p>
                                    <input type="text" class="input input-tooth-1" placeholder="1"><br>
                                    <input type="text" class="input input-tooth-2" placeholder="2"><br>
                                    <input type="text" class="input input-tooth-3" placeholder="3"><br>
                                    <input type="text" class="input input-tooth-4" placeholder="4"><br>
                                    <input type="text" class="input input-tooth-5" placeholder="5"><br>
                                    <input type="text" class="input input-tooth-6" placeholder="6"><br>
                                    <input type="text" class="input input-tooth-7" placeholder="7"><br>
                                    <input type="text" class="input input-tooth-8" placeholder="8"><br>
                                </div>
                                <div class="large-6 columns">
                                    <p>Upper Left</p>
                                    <input type="text" class="input input-tooth-9" placeholder="9">
                                    <br>
                                    <input type="text" class="input input-tooth-10" placeholder="10">
                                    <br>
                                    <input type="text" class="input input-tooth-11" placeholder="11">
                                    <br>
                                    <input type="text" class="input input-tooth-12" placeholder="12"><br>
                                    <input type="text" class="input input-tooth-13" placeholder="13"><br>
                                    <input type="text" class="input input-tooth-14" placeholder="14"><br>
                                    <input type="text" class="input input-tooth-15" placeholder="15"><br>
                                    <input type="text" class="input input-tooth-16" placeholder="16"> <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="large-12 columns">
                                    <svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg"
                                        version="1.1" width="289.61084" height="370.54398">
                                        ...
                                        <defs>
                                            ...
                                            <marker orient="auto" refY="0" refX="0" overflow="visible">
                                                <path d="m5.77 0-8.65 5 0-10 8.65 5z" transform="scale(-0.2,-0.2)"
                                                    style="fill-rule:evenodd;marker-start:none;stroke-width:1pt;stroke:#000" />
                                            </marker>
                                            <marker orient="auto" refY="0" refX="0" overflow="visible">
                                        ...
                                        <path class="tooth-11"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-12 tooth-12-parent"
                                        ...
                                        <path class="tooth-12"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-13 tooth-13-parent"
                                        ...
                                        <path class="tooth-13"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-14 tooth-14-parent"
                                        ...
                                        <path class="tooth-14"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-15 tooth-15-parent"
                                        ...
                                        <path class="tooth-15"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-16 tooth-16-parent"
                                        ...
                                        <path class="tooth-16"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-16" d="m 47.737092,125.50026 1.469421,-3.76848"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-17 tooth-17-parent"
                                        ...
                                        <path class="tooth-17"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-18 tooth-18-parent"
                                        ...
                                        <path class="tooth-18"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-21 tooth-21-parent"
                                        ...
                                        <path class="tooth-21"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-22 tooth-22-parent"
                                        ...
                                        <path class="tooth-22"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-23 tooth-23-parent"
                                        ...
                                        <path class="tooth-23"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-24 tooth-24-parent"
                                        ...
                                        <path class="tooth-24"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-25 tooth-25-parent"
                                        ...
                                        <path class="tooth-25"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-26 tooth-26-parent"
                                        ...
                                        <path class="tooth-26"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-26" d="m 241.30213,125.5344 -1.46941,-3.76845"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-27 tooth-27-parent"
                                        ...
                                        <path class="tooth-27"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-28 tooth-28-parent"
                                        ...
                                        <path class="tooth-28"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-31 tooth-31-parent"
                                        ...
                                        <path class="tooth-32"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-32 tooth-32-parent"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-33 tooth-33-parent"
                                        ...
                                        <path class="tooth-33"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-34 tooth-34-parent"
                                        ...
                                        <path class="tooth-34"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-35 tooth-35-parent"
                                        ...
                                        <path class="tooth-35"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-35" d="m 223.07985,287.46469 -0.21759,1.74743"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-36 tooth-36-parent"
                                        ...
                                        <path class="tooth-36"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-37 tooth-37-parent"
                                        ...
                                        <path class="tooth-37"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-37" d="m 233.10364,235.53151 3.64809,1.6142"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-37"
                                        ...
                                        <path class="tooth-37"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-38 tooth-38-parent"
                                        ...
                                        <path class="tooth-38"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-38" d="m 246.97457,201.3719 -2.22887,0.5041"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-38"
                                        ...
                                        <path class="tooth-38"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-41 tooth-41-parent"
                                        ...
                                        <path class="tooth-41"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-42 tooth-42-parent"
                                        ...
                                        <path class="tooth-42"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-43 tooth-43-parent"
                                        ...
                                        <path class="tooth-43"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-44 tooth-44-parent"
                                        ...
                                        <path class="tooth-44"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-45 tooth-45-parent"
                                        ...
                                        <path class="tooth-45"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-45" d="m 65.959389,287.43051 0.217589,1.74745"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-46 tooth-46-parent"
                                        ...
                                        <path class="tooth-46"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-47 tooth-47-parent"
                                        ...
                                        <path class="tooth-47"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-47" d="m 55.935605,235.49734 -3.648115,1.61422"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-47"
                                        ...
                                        <path class="tooth-47"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-48 tooth-48-parent"
                                        ...
                                        <path class="tooth-48"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-48" d="m 42.064659,201.33773 2.228886,0.50412"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="tooth-48"
                                        ...
                                        <path class="tooth-48"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <!-- Child Dentition -->
                                        <path class="child-tooth-51 child-tooth-51-parent"
                                        ...
                                        <path class="child-tooth-51"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-52 child-tooth-52-parent "
                                        ...
                                        <path class="child-tooth-52"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-53 child-tooth-53-parent "
                                        ...
                                        <path class="child-tooth-53"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-54 child-tooth-54-parent "
                                        ...
                                        <path class="child-tooth-54"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-54" d="m 94.135111,156.47331 0.971964,-2.69902"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-55 child-tooth-55-parent "
                                        ...
                                        <path class="child-tooth-55"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-61 child-tooth-61-parent "
                                        ...
                                        <path class="child-tooth-61"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-62 child-tooth-62-parent "
                                        ...
                                        <path class="child-tooth-62"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-63 child-tooth-63-parent "
                                        ...
                                        <path class="child-tooth-63"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-64 child-tooth-64-parent "
                                        ...
                                        <path class="child-tooth-64"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-64" d="m 199.28078,153.6762 -0.97192,-2.69903"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-65 child-tooth-65-parent "
                                        ...
                                        <path class="child-tooth-65"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-71 child-tooth-71-parent "
                                        ...
                                        <path class="child-tooth-71"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-72 child-tooth-72-parent "
                                        ...
                                        <path class="child-tooth-72"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-73 child-tooth-73-parent "
                                        ...
                                        <path class="child-tooth-73"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-74 child-tooth-74-parent "
                                        ...
                                        <path class="child-tooth-74"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-75 child-tooth-75-parent "
                                        ...
                                        <path class="child-tooth-75"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-75" d="m 201.5053,201.27629 -0.1547,1.80957"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-81 child-tooth-81-parent "
                                        ...
                                        <path class="child-tooth-82"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-82 child-tooth-82-parent "
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-83 child-tooth-83-parent "
                                        ...
                                        <path class="child-tooth-83"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-84 child-tooth-84-parent "
                                        ...
                                        <path class="child-tooth-84"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-85 child-tooth-85-parent "
                                        ...
                                        <path class="child-tooth-85"
                                            ...
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <path class="child-tooth-85" d="m 89.795748,201.24091 0.154722,1.80957"
                                            style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none" />
                                        <text xml:space="preserve" x="87.802124" y="124.42228"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="87.802124" y="124.42228">53</tspan>
                                        </text>
                                        <text xml:space="preserve" x="73.32402" y="141.07207"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="73.32402" y="141.07207">54</tspan>
                                        </text>
                                        <text xml:space="preserve" x="63.189354" y="163.51317"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="63.189354" y="163.51317">55</tspan>
                                        </text>
                                        <text xml:space="preserve" x="152.22969" y="100.53336"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="152.22969" y="100.53336">61</tspan>
                                        </text>
                                        <text xml:space="preserve" x="176.11855" y="110.66804"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="176.11855" y="110.66804">62</tspan>
                                        </text>
                                        <text xml:space="preserve" x="192.76837" y="120.80273"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="192.76837" y="120.80273">63</tspan>
                                        </text>
                                        <text xml:space="preserve" x="207.97037" y="139.62425"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="207.97037" y="139.62425">64</tspan>
                                        </text>
                                        <text xml:space="preserve" x="214.48553" y="164.96092"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="214.48553" y="164.96092">65</tspan>
                                        </text>
                                        <text xml:space="preserve" x="149.33405" y="276.44232"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="149.33405" y="276.44232">71</tspan>
                                        </text>
                                        <text xml:space="preserve" x="169.60339" y="271.375"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="169.60339" y="271.375">72</tspan>
                                        </text>
                                        <text xml:space="preserve" x="187.70103" y="262.68811"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="187.70103" y="262.68811">73</tspan>
                                        </text>
                                        <text xml:space="preserve" x="202.90305" y="244.5905"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="202.90305" y="244.5905">74</tspan>
                                        </text>
                                        <text xml:space="preserve" x="213.76163" y="217.08217"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="213.76163" y="217.08217">75</tspan>
                                        </text>
                                        <text xml:space="preserve" x="131.23643" y="275.71838"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="131.23643" y="275.71838">81</tspan>
                                        </text>
                                        <text xml:space="preserve" x="109.51928" y="269.92715"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="109.51928" y="269.92715">82</tspan>
                                        </text>
                                        <text xml:space="preserve" x="91.421661" y="259.79251"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="91.421661" y="259.79251">83</tspan>
                                        </text>
                                        <text xml:space="preserve" x="76.94355" y="240.97096"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="76.94355" y="240.97096">84</tspan>
                                        </text>
                                        <text xml:space="preserve" x="64.637154" y="217.08217"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="64.637154" y="217.08217">85</tspan>
                                        </text>
                                        <text xml:space="preserve" x="120.37785" y="17.284296"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="120.37785" y="17.284296">11</tspan>
                                        </text>
                                        <text xml:space="preserve" x="85.630409" y="28.142862"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="85.630409" y="28.142862">12</tspan>
                                        </text>
                                        <text xml:space="preserve" x="56.67421" y="43.344887"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="56.67421" y="43.344887">13</tspan>
                                        </text>
                                        <text xml:space="preserve" x="42.92001" y="64.338097"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="42.92001" y="64.338097">14</tspan>
                                        </text>
                                        <text xml:space="preserve" x="32.785339" y="88.226982"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="32.785339" y="88.226982">15</tspan>
                                        </text>
                                        <text xml:space="preserve" x="19.031139" y="110.66804"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="19.031139" y="110.66804">16</tspan>
                                        </text>
                                        <text xml:space="preserve" x="12.515995" y="141.07207"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="12.515995" y="141.07207">17</tspan>
                                        </text>
                                        <text xml:space="preserve" x="8.8964691" y="172.2"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="8.8964691" y="172.2">18</tspan>
                                        </text>
                                        <text xml:space="preserve" x="155.84921" y="17.284296"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="155.84921" y="17.284296">21</tspan>
                                        </text>
                                        <text xml:space="preserve" x="192.76837" y="29.590677"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="192.76837" y="29.590677">22</tspan>
                                        </text>
                                        <text xml:space="preserve" x="220.27673" y="44.068779"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="220.27673" y="44.068779">23</tspan>
                                        </text>
                                        <text xml:space="preserve" x="236.20268" y="64.338097"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="236.20268" y="64.338097">24</tspan>
                                        </text>
                                        <text xml:space="preserve" x="247.06125" y="86.779167"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="247.06125" y="86.779167">25</tspan>
                                        </text>
                                        <text xml:space="preserve" x="258.64374" y="109.22027"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="258.64374" y="109.22027">26</tspan>
                                        </text>
                                        <text xml:space="preserve" x="264.43497" y="139.62425"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="264.43497" y="139.62425">27</tspan>
                                        </text>
                                        <text xml:space="preserve" x="268.77841" y="169.3044"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="268.77841" y="169.3044">28</tspan>
                                        </text>
                                        <text xml:space="preserve" x="151.50578" y="360.41531"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="151.50578" y="360.41531">31</tspan>
                                        </text>
                                        <text xml:space="preserve" x="176.84245" y="355.34799"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="176.84245" y="355.34799">32</tspan>
                                        </text>
                                        <text xml:space="preserve" x="202.17912" y="346.6611"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="202.17912" y="346.6611">33</tspan>
                                        </text>
                                        <text xml:space="preserve" x="222.44849" y="330.01129"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="222.44849" y="330.01129">34</tspan>
                                        </text>
                                        <text xml:space="preserve" x="240.5461" y="309.01804"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="240.5461" y="309.01804">35</tspan>
                                        </text>
                                        <text xml:space="preserve" x="257.91986" y="282.95749"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="257.91986" y="282.95749">36</tspan>
                                        </text>
                                        <text xml:space="preserve" x="265.15891" y="245.31441"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="265.15891" y="245.31441">37</tspan>
                                        </text>
                                        <text xml:space="preserve" x="265.15891" y="214.18651"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="265.15891" y="214.18651">38</tspan>
                                        </text>
                                        <text xml:space="preserve" x="128.34082" y="360.41531"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="128.34082" y="360.41531">41</tspan>
                                        </text>
                                        <text xml:space="preserve" x="100.10851" y="356.79581"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="100.10851" y="356.79581">42</tspan>
                                        </text>
                                        <text xml:space="preserve" x="76.94355" y="347.38501"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="76.94355" y="347.38501">43</tspan>
                                        </text>
                                        <text xml:space="preserve" x="55.950298" y="330.01129"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="55.950298" y="330.01129">44</tspan>
                                        </text>
                                        <text xml:space="preserve" x="38.57658" y="310.46585"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="38.57658" y="310.46585">45</tspan>
                                        </text>
                                        <text xml:space="preserve" x="20.478951" y="287.30087"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="20.478951" y="287.30087">46</tspan>
                                        </text>
                                        <text xml:space="preserve" x="12.515995" y="244.5905"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                                            <tspan x="12.515995" y="244.5905">47</tspan>
                                        </text>
                                        <text xml:space="preserve" x="12.515995" y="214.18651"
                                            style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
                        ...
                        <div class="large-3 columns">
                            <div class="row">
                                <div class="large-6 columns">
                                    <p>Lower Right</p>
                                    <input type="text" class="input input-tooth-25" placeholder="25"><br>
                                    <input type="text" class="input input-tooth-26" placeholder="26"><br>
                                    <input type="text" class="input input-tooth-27" placeholder="27"><br>
                                    <input type="text" class="input input-tooth-28" placeholder="28"><br>
                                    <input type="text" class="input input-tooth-29" placeholder="29"><br>
                                    <input type="text" class="input input-tooth-30" placeholder="30"><br>
                                    <input type="text" class="input input-tooth-31" placeholder="31"><br>
                                    <input type="text" class="input input-tooth-32" placeholder="32"><br>
                                </div>
                                <div class="large-6 columns">
                                    <p>Lower Left</p>
                                    <input type="text" class="input input-tooth-17" placeholder="17"><br>
                                    <input type="text" class="input input-tooth-18" placeholder="18"><br>
                                    <input type="text" class="input input-tooth-19" placeholder="19"><br>
                                    <input type="text" class="input input-tooth-20" placeholder="20"><br>
                                    <input type="text" class="input input-tooth-21" placeholder="21"><br>
                                    <input type="text" class="input input-tooth-22" placeholder="22"><br>
                                    <input type="text" class="input input-tooth-23" placeholder="23"><br>
                                    <input type="text" class="input input-tooth-24" placeholder="24"><br>
                                </div>
                            </div>
                    ...
                    <div clsas="second">
                        <div class="dental-form">
                            <!-- Legends Section -->
                            <p><strong>INPUT CODES</strong></p>
                            <div class="legend">
                                <div class="haha">
                                    <p><strong class="code-style">Condition:<br><br></strong>
                                        <strong>✓</strong> - Present Teeth<br>
                                        <strong>D</strong> - Decayed<br>
                                        <strong>M</strong> - Missing due to Caries<br>
                                        <strong>Mo</strong> - Missing due to Other Causes<br>
                                        <strong>Im</strong> - Impacted Tooth<br>
                                        <strong>Sp</strong> - Supernumerary Tooth<br>
                                        <strong>Rf</strong> - Root Fragment<br>
                                        <strong>Un</strong> - Unerupted<br>
                                    </p>
                                </div>
                                <div class="haha">
                                    <p><strong class="code-style">Restorations & Prosthetics:<br><br></strong>
                                        <strong>Am</strong> - Amalgam Filling<br>
                                        <strong>Co</strong> - Composite Filling<br>
                                        <strong>JC</strong> - Jacket Crown<br>
                                        <strong>Ab</strong> - Abutment<br>
                                        <strong>Att</strong> - Attachment<br>
                                        <strong>P</strong> - Pontic<br>
                                        <strong>In</strong> - Inlay<br>
                                        <strong>Imp</strong> - Implant<br>
                                        <strong>S</strong> - Sealants<br>
                                        <strong>Rm</strong> - Removable Denture<br>
                                    </p>
                                </div>
                                <div class="haha">
                                    <p><strong class="code-style">Surgery:<br><br></strong>
                                        <strong>X</strong> - Extraction due to Caries<br>
                                        <strong>Xo</strong> - Extraction due to Other Causes<br>
                                    </p>
                                </div>
                            </div>
                            ...
                            <form action="#" method="POST">
                                <div class="section-div">
                                    <div class="section">
                                        <h4>X-ray Taken:</h4>
                                        <label><input type="checkbox" name="periapical"> Periapical</label><br>
                                        <label><input type="checkbox" name="panoramic"> Panoramic</label><br>
                                        <label><input type="checkbox" name="cephalometric"> Cephalometric</label><br>
                                        <label><input type="checkbox" name="occlusal"> Occlusal</label>
                                    </div>
                                    <div class="section">
                                        <h4>Periodontal Screening:</h4>
                                        <label><input type="checkbox" name="gingivitis"> Gingivitis</label><br>
                                        <label><input type="checkbox" name="early_periodontitis"> Early
                                            Periodontitis</label><br>
                                        <label><input type="checkbox" name="moderate_periodontitis"> Moderate
                                            Periodontitis</label><br>
                                        <label><input type="checkbox" name="advanced_periodontitis"> Advanced
                                            Periodontitis</label>
                                    </div>

                                    <div class="section">
                                        <h4>Occlusion:</h4>
                                        <label><input type="checkbox" name="class_molar"> Class (Molar)</label><br>
                                        <label><input type="checkbox" name="overjet"> Overjet</label><br>
                                        <label><input type="checkbox" name="overbite"> Overbite</label><br>
                                        <label><input type="checkbox" name="midline_deviation"> Midline
                                            Deviation</label><br>
                                        <label><input type="checkbox" name="crossbite"> Crossbite</label>
                                    </div>

                                    <div class="section">
                                        <h4>Appliances:</h4>
                                        <label><input type="checkbox" name="orthodontic"> Orthodontic</label><br>
                                        <label><input type="checkbox" name="stayplate"> Stayplate</label><br>
                                        <label><input type="checkbox" name="other_appliances"> Others</label>
                                    </div>

                                    <div class="section">
                                        <h4>TMD:</h4>
                                        <label><input type="checkbox" name="clenching"> Clenching</label><br>
                                        <label><input type="checkbox" name="clicking"> Clicking</label><br>
                                        <label><input type="checkbox" name="trismus"> Trismus</label><br>
                                        <label><input type="checkbox" name="muscle_spasm"> Muscle Spasm</label>
                                    </div>
                                </div>
                                <center>
                                    <div class="section">
