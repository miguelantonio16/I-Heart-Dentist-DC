<?php
/**
 * One-time script to create adminbacoor@edoc.com with password 123, and ensure webuser entry exists.
...
try {
    ...
    echo "Admin Bacoor account ensured. Email: $email, Password: $password\n";
