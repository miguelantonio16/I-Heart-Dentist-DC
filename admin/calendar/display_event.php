...
$display_query = "
    SELECT 
        ...
        p.procedure_name, pt.pname AS patient_name, d.docname AS dentist_name
    FROM appointment a
...
if ($selected_date) $display_query .= " AND a.appodate = '$selected_date'";
if ($dentist_id) $display_query .= " AND a.docid = '$dentist_id'";
if ($branch_id) $display_query .= " AND d.branch_id = '$branch_id'";
...
if (mysqli_num_rows($results) > 0) {
    while ($data_row = mysqli_fetch_assoc($results)) {
        ...
        $data_arr[] = [
            ...
            'title' => $data_row['event_name'] . " with " . $data_row['patient_name'],
            ...
            'patient_name' => $data_row['patient_name'],
                ...
                'branch_name' => isset($data_row['name']) ? $data_row['name'] : null,
            'color' => $event_color,
